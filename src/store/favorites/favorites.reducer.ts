...
export const favoritesReducer = (state = FAVORITES_INTITIAL_STATE, action = {} as AnyAction): FavoritesState => {
   ...
   if (refreshFavoritesStart.match(action))
      return {
         ...state,
         isLoading: true,
      }
   
   if (refreshFavoritesSucess.match(action))
      return {
         ...state,
   ...
   if (refreshFavoritesFailed.match(action))
      return {
         ...state,
...
export type UpdatedFavoritesState = {
...
const UPDATED_BOOKMARKS_INTITIAL_STATE: UpdatedFavoritesState = {
...
export const addRecipeToFavoritesReducer = (state = UPDATED_BOOKMARKS_INTITIAL_STATE, action = {} as AnyAction): UpdatedFavoritesState => {
...
export const removeRecipeFromFavoritesReducer = (state = UPDATED_BOOKMARKS_INTITIAL_STATE, action = {} as AnyAction): UpdatedFavoritesState => {
...
export const addRestaurantToFavoritesReducer = (state = UPDATED_BOOKMARKS_INTITIAL_STATE, action = {} as AnyAction): UpdatedFavoritesState => {
...
export const removeRestaurantFromFavoritesReducer = (state = UPDATED_BOOKMARKS_INTITIAL_STATE, action = {} as AnyAction): UpdatedFavoritesState => {
